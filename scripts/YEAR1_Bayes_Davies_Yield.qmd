...
survival <- read_excel(here("data", "YEAR1_Survival.xlsx"), na ="")
environment <- read_excel (here("data", "YEAR1 Benthic Environment ReefDev.xlsx"), na="")
```
...
plot_davies_ub <- ggplot() +
  ...
  labs(
    x = expression("Bottom stress (m s"^{-1}*")"),
  y = NULL,
  color = NULL,
) + 
 scale_color_manual(
...
plot_davies_speed <- ggplot() +
  ...
  labs(
      x = expression("Median flow velocity (m s"^{-1}*")"),
  y = NULL,
  color = NULL,
) + 
 scale_color_manual(
...
plot_davies_turf <- ggplot() +
  ...
  geom_jitter(data = davies_combined, 
              ...
              alpha = 0.5, width = 0.05, height = 0) +
   labs(
x = expression("Sediment on turf (mg cm"^{-2} * " day"^{-1} * ")"),
  y = NULL,
  color = NULL,
) + 
 scale_color_manual(
...
plot_davies_concrete <- ggplot() +
  ...
  geom_jitter(data = davies_combined, 
              ...
              alpha = 0.5, width = 0.05, height = 0) +
   labs(
x = expression("Sediment on concrete (mg cm"^{-2} * " day"^{-1} * ")"),
  y = NULL,
  color = NULL,
) + 
 scale_color_manual(
