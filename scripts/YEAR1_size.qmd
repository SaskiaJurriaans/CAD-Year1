...
davies_variables <- davies |>
  select(c(Spp, Size_log, Ub_avrg, WaveEnergyLevel, sedturf_t5, sedconcrete_t5, sedturf_t2, sedconcrete_t2,median_speed))
...
davies_brm6 <- new_species_davies |>
  select(c(sedturf_t5, Spp, Fitted, Lower, Upper))
davies_brm7 <- new_species_davies |>
  select(c(sedconcrete_t5, Spp, Fitted, Lower, Upper))
```
...
```{r}
# Create the plot with points, error bars, and raw data
plot_davies_turf2 <- ggplot() +
  # Plot the raw data points, colored in green
  geom_jitter(data = davies_combined, aes(x = sedturf_t2, y = Size_log, color = Spp), alpha = 0.5, width = 0.08, height = 0) +
  geom_errorbar(data = predicted_data_davies_brm4, aes(x = sedturf_t2, ymin = Lower, ymax = Upper), color = "black", width = 0.08, alpha = 0.5) +
  geom_point(data = predicted_data_davies_brm4, aes(x = sedturf_t2, y = Fitted), color = "black") +
   labs(
    x = "Sedimentation on turf (mg cm-2",
    y = "Predicted growth (mm3)",
    color = "Species",
...
```{r}
# Create the plot with points, error bars, and raw data
plot_davies_concrete2 <- ggplot() +
  # Plot the raw data points, colored in green
  geom_jitter(data = davies_combined, aes(x = sedconcrete_t2, y = Size_log, color = Spp), alpha = 0.5, width = 0.02, height = 0) +
  geom_errorbar(data = predicted_data_davies_brm5, aes(x = sedconcrete_t2, ymin = Lower, ymax = Upper), color = "black", width = 0.025, alpha = 0.5) +
  geom_point(data = predicted_data_davies_brm5, aes(x = sedconcrete_t2, y = Fitted), color = "black") +
   labs(
        x = "Sedimentation on concrete (mg cm-2",
    y = "Predicted growth (mm3)",
    color = "Species",
...
```{r}
# Extract fitted values and predictors 
fitted_values_davies_brm6 <- fitted(davies_brm6_size, summary = FALSE)

predicted_data_davies_brm6 <- data.frame(  
  sedturf_t5 = davies$sedturf_t5,  
  Spp = davies$Spp,  
  Fitted = apply(fitted_values_davies_brm6, 2, mean), 
  Lower = apply(fitted_values_davies_brm6, 2, function(x) quantile(x, 0.025)), 
  Upper = apply(fitted_values_davies_brm6, 2, function(x) quantile(x, 0.975)) )

# Combine the new species data with the original predicted data
predicted_data_davies_brm6 <- rbind(predicted_data_davies_brm6, davies_brm6)
```
...
```{r}
# Create the plot with points, error bars, and raw data
plot_davies_turf5 <- ggplot() +
  # Plot the raw data points, colored in green
  geom_jitter(data = davies_combined, aes(x = sedturf_t5, y = Size_log, color = Spp), alpha = 0.5, width = 0.08, height = 0) +
  geom_errorbar(data = predicted_data_davies_brm6, aes(x = sedturf_t5, ymin = Lower, ymax = Upper), color = "black", width = 0.025, alpha = 0.5) +
  geom_point(data = predicted_data_davies_brm6, aes(x = sedturf_t5, y = Fitted), color = "black") +
   labs(
        x = "Sedimentation on turf (mg cm-2",
    y = "Predicted growth (mm3)",
    color = "Species",
...
```{r}
# Extract fitted values and predictors 
fitted_values_davies_brm7 <- fitted(davies_brm7_size, summary = FALSE)

predicted_data_davies_brm7 <- data.frame(  
  sedconcrete_t5 = davies$sedconcrete_t5,  
  Spp = davies$Spp,  
  Fitted = apply(fitted_values_davies_brm7, 2, mean), 
  Lower = apply(fitted_values_davies_brm7, 2, function(x) quantile(x, 0.025)), 
  Upper = apply(fitted_values_davies_brm7, 2, function(x) quantile(x, 0.975)) )

# Combine the new species data with the original predicted data
predicted_data_davies_brm7 <- rbind(predicted_data_davies_brm7, davies_brm7)
```
...
plot_davies_concrete <- ggplot() +
  # Plot the raw data points, colored in green
  geom_jitter(data = davies_combined, aes(x = sedconcrete_t5, y = Size_log, color = Spp), alpha = 0.5, width = 0.02, height = 0) +
  geom_errorbar(data = predicted_data_davies_brm7, aes(x = sedconcrete_t5, ymin = Lower, ymax = Upper), color = "black", width = 0.05, alpha = 0.5) +
  geom_point(data = predicted_data_davies_brm7, aes(x = sedconcrete_t5, y = Fitted), color = "black") +
   labs(
...
ggsave("output/figures growth/Davies Predicted growth Turf2.jpeg", plot_davies_turf2, width = 10, height = 6)
ggsave("output/figures growth/Davies Predicted growth Turf5.jpeg", plot_davies_turf5, width = 10, height = 6)
ggsave("output/figures growth/Davies Predicted growth Concrete5.jpeg", plot_davies_concrete, width = 10, height = 6)
ggsave("output/figures growth/Davies Predicted growth Concrete2.jpeg", plot_davies_concrete2, width = 10, height = 6)
```
...
ggsave("Figure Growth AllReefs.jpeg", plot = capture_plot(), width = 8, height = 6)
```
