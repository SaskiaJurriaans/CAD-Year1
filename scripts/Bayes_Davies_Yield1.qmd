...
looic(davies_brm)           # LOOIC: 268.24 [13.73]
looic(davies_brm_speed)     # LOOIC: 263.63 [13.58]
looic(davies_brm_wave)      # LOOIC: 266.09 [13.76]
looic(davies_brm_concrete)  # LOOIC: 265.66 [13.62]
looic(davies_brm_turf)      # LOOIC: 265.17 [13.66]
looic(davies_brm_PC1)       # LOOIC: 265.17 [13.66]
...
```{r}
davies.speed.brm$fit |> tidyMCMC(estimate.method = "median", 
                            conf.int = TRUE, 
