...
```{r}
davies_brm1_time |> summary()
davies_brm2_time_wave|> summary()
davies_brm3_time_Ub|> summary()
davies_brm4_time_current|> summary()
davies_brm5_time_turf|> summary()
davies_brm6_time_concrete|> summary()
davies_brm7_time_PCA|> summary()
```
### brm t6:
```{r}
davies_brm8_t6 |> summary()
davies_brm8_t6_wave|> summary()
