...
class "b" -\> for regression coefficent (slope, we do not have)

class "sd" -\> for standard deviations of random effects

```{r}
priors1 <- prior(normal(0, 1.7), class = "Intercept") +
   prior(student_t(3, 0, 1.5), class = 'sd')

priors2 <- prior(normal(0, 1.7), class = "Intercept") +
...
```{r}
heron_brm2 <- brm(heron_form_speed,
                 data=heron_t2,
                 prior = priors2,
                 sample_prior = 'yes',
                 iter = 5000,
